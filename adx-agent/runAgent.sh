...
javac -cp lib/adx-1.2.8.jar:lib/commons-math3-3.5.jar:lib/libsvm.jar helpers/*.java
javac -cp lib/adx-1.2.8.jar:lib/commons-math3-3.5.jar:lib/libsvm.jar:.:helpers AdNetwork.java
