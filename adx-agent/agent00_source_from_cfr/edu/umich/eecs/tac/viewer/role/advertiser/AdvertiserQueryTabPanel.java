...
public class AdvertiserQueryTabPanel
extends JPanel {
    private int agent;
    ...
    public AdvertiserQueryTabPanel(int agent, String advertiser, Query query, ResultsPageModel resultsPageModel, TACAASimulationPanel simulationPanel, Color legendColor) {
        this.agent = agent;
